...
if(isLoading){
  ...
  <div className="container px-xl-0 px-5 ">
    ...
    <Helmet>
      ...
      <div className="col-3">
        <div>
           <img className='w-100' style={{height:'150px'}} src={require('../../images/images/grocery-banner.png')} alt="" /> 
        </div>
        <div>
        <img className='w-100' style={{height:'150px'}} src={require('../../images/images/grocery-banner-2.jpeg')} alt="" /> 
